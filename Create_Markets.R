...
# This file uses Stata Can shape files and population center characteristics to create the list of market used in the paper
# read me provides details on locating these imported files
...
##------Import Geographies as shape files 
geo_prov <- folder%>%
...
## -----------------------------------------------Merge Files then Impose Market Restrictions ---------------------------------------- ##----

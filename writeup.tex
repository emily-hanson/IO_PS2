...
EMILY Work in porgress

In order to satisfy the requirements of independent markets, we follow an approach similar to Bresnahan and Reiss using smaller town far enough away from larger cities and other small towns \citep{BresReiss}. 
In Canada, a loca

Our analysis focuses on population centers sufficently  
